...
info = """Чат бот Vkinder. Данный бот подбирает аккауты автоматически или по заданным условиям и выдает ссылку и 3 самых популярных фотографии подобранного аккаунта. 
